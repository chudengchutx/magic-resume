            ...
            <Card className="overflow-hidden border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-gray-900/50">
              <CardHeader>
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-green-50 dark:bg-green-900/20 shrink-0">
                  ...
                  <div className="space-y-1">
                    ...
                    <CardDescription className="text-base text-gray-500 dark:text-gray-400 leading-relaxed">
                      {t("dashboard.settings.tauriStorage")}
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="h-12 px-4 flex items-center gap-3 bg-green-50/50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
                  <Folder className="h-5 w-5 text-green-600 dark:text-green-400" />
                  <span className="font-medium text-gray-700 dark:text-gray-300 font-mono text-sm">
                    ~/Documents/MagicResume/
                  </span>
                </div>
              </CardContent>
            </Card>
